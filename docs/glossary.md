...
**KO**
Un Pokemon à 0 PV est définitivement KO. Son corps reste sur la tile et bloque le passage. Seule la capacité **Vœu Soin** (`healing-wish` réinventé, plan 147 — pas « Second Souffle », qui est un autre move non implémenté) peut ranimer un allié KO — revive à 50% PV max, en échange du sacrifice du lanceur. Ne ranime pas le dernier mort d'un camp entièrement éliminé en ligne (plan 210) ; en local, si.
