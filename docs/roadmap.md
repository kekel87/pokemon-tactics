...
- [ ] **Talents & items de finition** — compléter pool transversal une fois moves livrés. Pool restant : abilities 52/114, items 71/~159 (OP sets déjà à 100% — finition = couverture exhaustive movepools Gen 1 pour Team Builder libre).
