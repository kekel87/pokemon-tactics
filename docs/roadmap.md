...
> Assets **Kenney CC0** : `input-prompts-pixel-1-bit` **déjà intégré** (chantier séparé « aide visuelle des gestes attendus », en fin de Lot 1, 2026-08-20) — choix humain **contre** la reco initiale `input-prompts` 64×64 couleur, tranché hors du Lot 2. `cursor-pixel-pack` reste non intégré, à évaluer au Lot 2. Voir `docs/next.md` et `docs/references/kenney-input-prompts-tileset.md`.
