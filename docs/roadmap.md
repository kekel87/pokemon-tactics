...
> Assets **Kenney CC0** à intégrer au Lot 2 : `input-prompts-pixel-1-bit` + `cursor-pixel-pack` (choix humain 2026-08-20, contre la reco initiale `input-prompts` 64×64 couleur — voir `docs/next.md`).
