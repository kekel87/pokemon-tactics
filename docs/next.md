...
- **Méta-plan Team Builder** (validé 2026-05-12) :
  ...
  - **085** — `TeamEditScene` style Pokemon Champion (6 slots, édition slot active, boutons Set OP / Importer / Exporter Showdown, items non implémentés grisés) → **prochain**
...
**Phase 3 terminée (2026-04-26). Phase 4 en cours (plans 069–084b terminés + bugfixes).** Abilities, genres, natures, objets tenus, SP, Roster Batch A-E, Météo complète (Sun/Rain/Sand/Snow) livrés. 81 Pokemon jouables — roster Gen 1 complet (hors Ditto). 160/160 op-sets full. Prochain : Team Builder (085 TeamEditScene). Méga-évolutions (Phase 9). Voir "À faire maintenant" ci-dessus.
