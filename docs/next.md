...
- **Méta-plan Team Builder** (validé 2026-05-12) :
  ...
  - **083** — Roster Batch F : impl moves/abilities/items prioritaires selon analyse 082 (suit pattern Batch C/D/E). **Scope réel = très petit** : 4 moves 🟢 (weather-ball, giga-drain, solar-beam, focus-blast) + 2 items 🟡 (choice-specs, eviolite) + 0 ability. Optionnel : 8 items 🟢 Low.
