...
> MAJ : 2026-05-22 (Phase 4 — Plan 094 done : Charge moves visibles + Flinch core + learnset extensions)
...
**Phase 4 en cours.** Plans 069–094 terminés. Roster Gen 1 complet à 81 Pokemon jouables + dummy. OP Sets : 163/163 `full` (100%). Météo complète. Team Builder UI livré. Moves TP (Fly/Dig/Bounce/Phantom-Force/Shadow-Force/Dive/Teleport) livrés avec états semi-invulnérables. IDs kebab normalisés en build-time. HitAndRun livré. Baton Pass livré. Charge moves visibles livrés (Skull Bash/Sky Attack/Razor Wind + Flinch core). **160 moves** implémentés.

Prochains candidats : Content Batch G, mécaniques avancées terrain/barrières, intégration Legends Z-A learnsets. Méga-évolutions → Phase 9.
