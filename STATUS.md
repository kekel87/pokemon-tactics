...
> MAJ : 2026-05-20 (Phase 4 — Gender toggle TeamEditScene + bugfix data reference learnsets/Kangaskhan)
...
**Phase 4 en cours.** Plans 069–087 terminés. Roster Gen 1 complet à 80 Pokemon jouables + dummy. OP Sets : 160/160 `full` (100%). Météo complète. Team Builder UI livré + TeamSelectScene refonte. `roster-poc` mort — remplacé par `playable-pokemon` + dérivation movepool/ability.

Bugs playtest résolus (MapSelect preview noire + caméra 12v1, 2026-05-20). Prochain : Content Batch G ou plan mécanique Phase 4 suivant. Méga-évolutions → Phase 9.
