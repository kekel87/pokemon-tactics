...
> MAJ : 2026-05-21 (Phase 4 — Plan 088 done : TargetingKind.Teleport + 7 moves TP + semi-invulnerable states + 2-turn moves refonte)
...
**Phase 4 en cours.** Plans 069–088 terminés. Roster Gen 1 complet à 80 Pokemon jouables + dummy. OP Sets : 160/160 `full` (100%). Météo complète. Team Builder UI livré. Moves TP (Fly/Dig/Bounce/Phantom-Force/Shadow-Force/Dive/Teleport) livrés avec états semi-invulnérables.

Prochains candidats : **plan 089** (normalisation IDs Showdown→kebab build-time, draft prêt) ou Content Batch G ou HitAndRun (u-turn/volt-switch/flip-turn). Méga-évolutions → Phase 9.
