...
> MAJ : 2026-05-21 (Phase 4 — Plan 092 done : HitAndRun moves)
...
**Phase 4 en cours.** Plans 069–092 terminés. Roster Gen 1 complet à 81 Pokemon jouables + dummy. OP Sets : 160/160 `full` (100%). Météo complète. Team Builder UI livré. Moves TP (Fly/Dig/Bounce/Phantom-Force/Shadow-Force/Dive/Teleport) livrés avec états semi-invulnérables. IDs kebab normalisés en build-time, zéro translation runtime downstream. HitAndRun livré (U-Demi-Tour/Voltampère/Passe-Vite). **157 moves** implémentés.

Prochains candidats : Content Batch G, MoveCharging visible (Skull Bash / Sky Attack), Baton Pass, ou mécaniques avancées terrain/barrières. Méga-évolutions → Phase 9.
