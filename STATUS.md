...
> MAJ : 2026-05-21 (Phase 4 — Plans 090+091 done : Sandbox Studio + design system migration)
...
**Phase 4 en cours.** Plans 069–089 terminés. Roster Gen 1 complet à 80 Pokemon jouables + dummy. OP Sets : 160/160 `full` (100%). Météo complète. Team Builder UI livré. Moves TP (Fly/Dig/Bounce/Phantom-Force/Shadow-Force/Dive/Teleport) livrés avec états semi-invulnérables. IDs kebab normalisés en build-time, zéro translation runtime downstream.

Prochains candidats : Content Batch G ou HitAndRun (`u-turn`/`volt-switch`/`flip-turn`). Méga-évolutions → Phase 9.
