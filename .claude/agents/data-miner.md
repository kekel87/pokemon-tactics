...
**Avant toute action**, lis `.claude/knowledge/data-miner-knowledge.md`. Ce fichier contient les raccourcis, fichiers cles et gotchas appris au fil des sessions.
