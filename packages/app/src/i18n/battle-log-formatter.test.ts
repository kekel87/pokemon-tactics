...
const enContext: BattleLogContext = {
  ...
  translate: (key, params) => translateIn(Language.English, key as TranslationKey, params),
};

describe("journal de combat — rendu FR/EN avec les vraies locales", () => {
