...
// Team identity colours moved to `@pokemon-tactic/render-ports` (plan 125),
// shared by view-core + every renderer. Re-exported here for the app-shell callers.
export { getTeamColorByPlayerId, TEAM_COLORS } from "@pokemon-tactic/render-ports";
// Field-terrain colours moved to `@pokemon-tactic/view-core` (plan 125). Only
// the two consumed by the app-shell combat-screen demo are re-exported here; the
// Babylon renderer imports the full set straight from `@pokemon-tactic/view-core`.
export {
...
export const PLACEMENT_FINISH_BUTTON_WIDTH = 120;
export const PLACEMENT_FINISH_BUTTON_HEIGHT = 36;
export const PLACEMENT_FINISH_BUTTON_BG = 0x335533;
export const PLACEMENT_FINISH_BUTTON_BORDER = 0x66cc66;
...
// Raised tiles (elevation > 0) share the Pokemon depth ladder so a Pokemon
// physically behind a pillar is correctly occluded by it. Flat tiles stay at
...
export const MAP_SELECT_LEFT_PANEL_BG_COLOR = 0x14142a;
export const MAP_SELECT_LIST_ITEM_COLOR = 0x222235;
export const MAP_SELECT_LIST_ITEM_SELECTED_COLOR = 0x335577;
export const MAP_SELECT_LIST_ITEM_HOVER_COLOR = 0x2a2a45;
export const MAP_SELECT_DETAILS_BG_COLOR = 0x111122;
export const MAP_SELECT_DETAILS_BG_ALPHA = 0.75;
export const MAP_SELECT_PREVIEW_BG_COLOR = 0x0a0a18;
