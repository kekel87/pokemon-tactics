...
export {
  ...
  AURA_RING_PULSE_MIN_ALPHA as BABYLON_AURA_RING_PULSE_MIN_ALPHA,
  AURA_RING_PULSE_PERIOD_MS as BABYLON_AURA_RING_PULSE_PERIOD_MS,
  AURA_RING_STACK_PITCH as BABYLON_AURA_RING_STACK_PITCH,
  ...
  PICK_DRAG_THRESHOLD_TOUCH_PX as BABYLON_PICK_DRAG_THRESHOLD_TOUCH_PX,
  PINCH_ZOOM_STEP_RATIO as BABYLON_PINCH_ZOOM_STEP_RATIO,
  ...
  ZOOM_DEFAULT_INDEX as BABYLON_ZOOM_DEFAULT_INDEX,
  ZOOM_LERP as BABYLON_ZOOM_LERP,
  ZOOM_LERP_EPSILON as BABYLON_ZOOM_LERP_EPSILON,
  ZOOM_LEVELS as BABYLON_ZOOM_LEVELS,
