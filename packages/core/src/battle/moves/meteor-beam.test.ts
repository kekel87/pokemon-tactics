...
describe("meteor-beam", () => {
  it("T1 charge locks caster on meteor-beam without dealing damage", () => {
    ...
    expect(casterState?.chargingMove?.moveId).toBe("meteor-beam");
    expect(casterState?.lockedMoveId).toBe("meteor-beam");
